var server              = 'http://api.gamers.tm/'; //'http://localhost:3000/'; // //'http://api.gamers.tm/'; //;//http://api.gamers.tm/' 
var origin              = 'http://www.gamers.tm/'; //'http://localhost:8000/'; ////'http://localhost:8000/';  //'http://www.gamers.tm/';////
