$(function () {
    ...
    $('#monSched').html(sched_template(page_data.custom_fields.mondaySchedule))
        .promise().done(function (e) {
            if (!page_data.custom_fields.mondaySchedule || !page_data.custom_fields.mondaySchedule.trim().length) {
                countEmpty++;
                //console.log(1);
                $(this).parent().hide();
            }
    ...
    $('#tueSched').html(sched_template(page_data.custom_fields.tuesdaySchedule))
        .promise().done(function (e) {
            if (!page_data.custom_fields.tuesdaySchedule || !page_data.custom_fields.tuesdaySchedule.trim()
                .length) {
                countEmpty++;
                //console.log(2);
                $(this).parent().hide();
    ...
    $('#wedSched').html(sched_template(page_data.custom_fields.wednesdaySchedule))
        .promise().done(function (e) {
            if (!page_data.custom_fields.wednesdaySchedule || !page_data.custom_fields.wednesdaySchedule.trim()
                .length) {
                countEmpty++;
                //console.log(3);
                $(this).parent().hide();
    ...
    $('#thuSched').html(sched_template(page_data.custom_fields.thursdaySchedule))
        .promise().done(function (e) {
            if (!page_data.custom_fields.thursdaySchedule || !page_data.custom_fields.thursdaySchedule.trim()
                .length) {
                countEmpty++;
                //console.log(4);
                $(this).parent().hide();
    ...
    $('#friSched').html(sched_template(page_data.custom_fields.fridaySchedule))
        .promise().done(function (e) {
            if (!page_data.custom_fields.fridaySchedule || !page_data.custom_fields.fridaySchedule.trim().length) {
                countEmpty++;
                //console.log(5);
                $(this).parent().hide();
            }
    ...
    $('#satSched').html(sched_template(page_data.custom_fields.saturdaySchedule))
        .promise().done(function (e) {
            if (!page_data.custom_fields.saturdaySchedule || !page_data.custom_fields.saturdaySchedule.trim()
                .length) {
                countEmpty++;
                //console.log(6);
                $(this).parent().hide();
    ...
    $('#sunSched').html(sched_template(page_data.custom_fields.sundaySchedule))
        .promise().done(function (e) {
            if (!page_data.custom_fields.sundaySchedule || !page_data.custom_fields.sundaySchedule.trim().length) {
                countEmpty++;
                //console.log(7);
                $(this).parent().hide();
            }
    ...
    if (typeof page_data.custom_fields !== 'undefined' && typeof page_data.custom_fields.streamingImage !==
        'undefined' && page_data.custom_fields.streamingImage !== '') {
        $("meta[property='og\\:image']").attr("content", community + 'data/streaming/' + page_data.user_id +
            '/' + page_data.custom_fields.streamingImage);
        $("meta[name='twitter\\:image\\:src']").attr("content", community + 'data/streaming/' + page_data.user_id +
            '/' + page_data.custom_fields.streamingImage);
    }
...
var updateStatus = function(streamType, streamId, isOnline) {
    if (isOnline) {
...
var getViewersCount = function (url) {
...
var render_stream = function (streamType, streamId) {
    var viewers = 0;
    if (streamType == 'TW') {
