...
var __t, __p = '', __e = '';
with (obj) {
__p += '<div class="chat-{{TWITCHID}}" id="tab-chat-{{TWITCHID}}">\n  <iframe src="http://www.hitbox.tv/embedchat/{{TWITCHID}}?autoconnect=true" width="100%" height="100%">\n  </iframe>\n</div>\n';
...
var __t, __p = '', __e = '';
with (obj) {
__p += '<div class="chat-{{TWITCHID}}" id="tab-chat-{{TWITCHID}}">\n  <iframe src="http://www.twitch.tv/{{TWITCHID}}/chat?popout=true" width="100%" height="100%">\n  </iframe>\n</div>\n';
